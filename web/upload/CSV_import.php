...
/*
 CSV_import class provides interface to a quick CSV file to MySQL database import. Much quicker (10-100 times) that line by line SQL INSERTs.
 version: 1.5
...
class CSV_import
{
  ...
  var $error; //error messagevar $error;
