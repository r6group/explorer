...
//var_dump($sumscreen);
$this->title = 'เป้าหมายเบาหวาน 15 ปีขึ้นไปที่ยังไม่ได้รับบริการการคัดกรอง';
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        echo GridView::widget([
            ...
            'hover' => true,
            'panel' => [
                'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-globe"></i> รายชื่อกลุ่มเป้าหมายเบาหวาน 15 ปีขึ้นไปที่ยังไม่ได้รับบริการการคัดกรอง</h3>'],
